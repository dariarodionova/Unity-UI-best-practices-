...
Frequently, the logic of the game assumes that some UI is turned on on start, some appears while the user is interacting with the game/app and some should only appear saldom.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTEyMDExOTgsLTg3Mjg3OTU4MCwtMz
