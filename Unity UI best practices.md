...
This list will walk you through UI-specific best practices that could be used when working with Unity engine and UI in general. Of course, situation very from project to project and goal to goal, but general prinsiples remain the same. This will also be very helpful if there is a team working on UI, including visual and game designers, programmers or any other stakeholders.
## General
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyNjc3Njg4MiwtMTM5MTI2MDcyMywtMT
